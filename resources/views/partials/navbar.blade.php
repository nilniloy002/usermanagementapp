<nav class="navbar fixed-top align-items-start navbar-expand-lg pl-0 pr-0 py-0" >
    ...
    <div class="navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand mr-0" href="{{ url('/') }}">
            <img src="https://sts.institute/wp-content/uploads/2024/08/Logo-v2-01.png" class="logo-lg" height="50" alt="{{ setting('app_name') }}">
            <img src="{{ url('assets/img/logo-no-text.png') }}" class="logo-sm" height="50" alt="{{ setting('app_name') }}">
        </a>
    </div>
