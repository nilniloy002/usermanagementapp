...
<div class="card">
    <div class="card-body">
        <form action="{{ isset($mockTestRegistration) ? route('mock_test_registrations.update', $mockTestRegistration) : route('mock_test_registrations.store') }}" 
            ...
            <!-- Exam Status -->
            <div class="form-group">
                <label for="exam_status_id">@lang('Candidate Status')</label>
                <select name="exam_status_id" id="exam_status_id" class="form-control">
                    <option value="">@lang('Select Candidate Status')</option>
                    @foreach ($statuses as $status)
                        <option value="{{ $status->id}}" 
                            {{ isset($mockTestRegistration) && $mockTestRegistration->exam_status == $status->id ? 'selected' : '' }}>
                            {{ $status->mock_status }}
                        </option>
                    @endforeach
                </select>
            ...
            <!-- Mock Test Number -->
            <div class="form-group">
                <label for="mock_test_no">@lang('Mock Test No')</label>
