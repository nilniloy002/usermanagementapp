...
<head>
    ...
    <title>Payment Approved - STS Institute</title>
    <style>
    ...
    <div class="email-container">
        ...
        <div class="content">
            <div class="greeting">
                ...
                This email confirms that we have received your payment for <strong class="approval-badge">{{ $payment->payment_category }}</strong>.
            </div>
            ...
            @if($payment->course && strpos(strtolower($payment->course->course_name), 'ielts on computer') !== false)
            <div class="assets-section">
                <div class="section-title">Guide Assets - {{ $payment->course->course_name }}</div>
