...
class StudentAdmissionController extends Controller
{
    ...
    {
        $applications = StudentAdmission::with(['course', 'batch'])
...
//             'remarks' => 'nullable|string|max:500',
//         ], [
//             'next_due_date.required_if' => 'Next due date is required when there is due amount.',
//         ]);
...
//         // Use database transaction to ensure data consistency
//         \DB::transaction(function () use ($admission, $validated, $batch) {
//             // Update admission
//             $admission->update([
//                 'batch_id' => $validated['batch_id'],
//                 'deposit_amount' => $validated['deposit_amount'],
...
//             // IMPORTANT: Update batch enrolled count
//             $batch->increment('enrolled_students');
//         });
...
// }
    ...
    public function bulkIdCards(Request $request)
    {
        ...
        $students = StudentAdmission::with(['course', 'batch'])
            ->where('status', 'approved')
